...
var Library = (function (_super) {
    ...
    function Library(models, options) {
        var _this = _super.call(this, models, options) || this;
        _this.comparator = "title";
        _this.comparator = function (model) { return 1; };
        _this.comparator = function (model) { return "Title"; };
        _this.comparator = function (model1, model2) { return 1; };
        return _this;
    }
    return Library;
}(Backbone.Collection));
